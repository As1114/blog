...
type CommentModel struct {
	...
	Content            string          `gorm:"size:256;comment:评论内容" json:"content"`
	DiggCount          int             `gorm:"size:8;default:0;comment:点赞数" json:"digg_count"`
	CommentCount       int             `gorm:"size:8;default:0;comment:子评论数" json:"comment_count"`
	ArticleID          string          `gorm:"size:32;comment:文章id" json:"article_id"`
